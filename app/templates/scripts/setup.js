...
var config = require('baboon/lib/config')(path.join(__dirname, '../'), {config: 'production'});
var loggers = require('baboon/lib/logging')(config);
var rights = require('baboon/lib/rights.js')(config, loggers);
